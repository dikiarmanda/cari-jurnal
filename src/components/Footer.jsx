...
const Footer = () => {
  return (
    <footer className="footer grid-flow-col items-center p-4 lg:px-20 bg-primary text-primary-content">
      ...
      <nav className="grid-flow-col justify-self-end">
        <a href="https://www.instagram.com/umsida.dev"><FontAwesomeIcon icon={faInstagram} size="2xl" /></a>
      </nav>
    </footer>
  )
}
